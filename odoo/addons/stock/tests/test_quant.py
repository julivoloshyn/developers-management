...
class StockQuant(TransactionCase):
    ...
    def test_increase_available_quantity_3(self):
        ...
        if not quant:
            self.skipTest('Cannot tests concurrent transactions without demo data.')
    ...
    def test_increase_available_quantity_5(self):
        ...
        Increase a subLocation and check that quants are in this location. Also tests inverse.
        """
    ...
    def test_in_date_6(self):
        """
        One P in stock, P is delivered. Later on, a stock adjustement adds one P. This tests checks
    ...
    def test_quant_creation(self):
        """
        This tests ensures that, after an internal transfer, the values of the created quand are correct
        """
