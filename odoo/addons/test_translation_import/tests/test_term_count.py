...
class TestImport(common.TransactionCase):
    ...
    def test_import_code_translation(self):
        ...
        model = self.env['tests.translation.import.model1']
        self.assertEqual(
    ...
    def test_lazy_translation(self):
        ...
        # tests lazy translation in another module
        self.env['res.lang']._activate_lang('fr_FR')
        context = {'lang': 'en_US'}
    ...
    def test_translation_placeholder(self):
        ...
        model_fr_BE = self.env['tests.translation.import.model1'].with_context(lang='fr_BE')
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_import(self):
        ...
        # tests model and model terms translations
        record = self.env.ref('test_translation_import.test_translation_import_model1_record1')
    ...
    def test_export_records(self):
        ...
        po_reader = TranslationRecordReader(self.env.cr, 'tests.translation.import.model1', model1_ids, lang='fr_FR')
        ...
        po_reader = TranslationRecordReader(self.env.cr, 'tests.translation.import.model2', model2_ids, lang='fr_FR')
        translations = {line[4]: line[5] for line in po_reader}
        self.assertDictEqual(
            translations,
            {
