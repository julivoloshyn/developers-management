...
class PosPaymentMethod(models.Model):
    ...
    adyen_test_mode = fields.Boolean(help='Run transactions in the tests environment.', groups='base.group_erp_manager')
    ...
    def _proxy_adyen_request_direct(self, data, operation):
        ...
        environment = 'tests' if self.sudo().adyen_test_mode else 'live'
