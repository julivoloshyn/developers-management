...
class AccountJournal(models.Model):
    ...
    def _l10n_sa_prepare_invoice_xml(self, xml_content):
        """
            Prepare the XML content of the tests invoices before running the compliance checks
        """
        ...
        # Update the Company VAT number in the tests invoice
        vat_el = _get_node('//cbc:CompanyID')
        vat_el.text = self.company_id.vat

        # Update the Company Name in the tests invoice
