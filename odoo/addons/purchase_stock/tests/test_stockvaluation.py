...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def test_valuation_multicurrency_with_tax_without_account(self):
        """ Similar tests as test_valuation_multicurrency_with_tax, but without the accounts in the tax.
        Tax without accounts will increment the stock value (check test_valuation_from_increasing_tax).
        In this tests, we verify that the amount_currency is also impacted by these changes.
        """
    ...
    def test_purchase_with_backorders_and_return_and_price_changes(self):
        ...
        In this tests, we ensure that if the Control Policy is 'On received quantities' (procure_method = 'receive'),
    ...
    def test_invoice_on_ordered_qty_with_backorder_and_different_currency_manual(self):
        """Same tests as test_invoice_on_ordered_qty_with_backorder_and_different_currency_automated with manual_periodic valuation
